...
const testimonials = [
  {
    ...
    role: "CEO",
    quote:
      "My office space has been transformed by Trinity. The team listened carefully and delivered something beyond what we imagined — clients comment on it constantly.",
    name: "Julia Adams",
    title: "JA Group",
    avatar: avatar1,
  },
  {
    ...
    role: "Founder",
    quote:
      "From the first sketches to the final styling, every detail felt considered. The space is calmer, brighter and finally feels like ours.",
    name: "Maya Chen",
    title: "Studio North",
    avatar: avatar3,
  },
  {
    ...
    role: "Director",
    quote:
      "Trinity navigated a complex renovation with grace. On time, on budget, and the craftsmanship is genuinely exceptional.",
    name: "Sophie Laurent",
    title: "Laurent & Co.",
    avatar: avatar5,
  },
    ...
    <section className="mt-24 bg-[oklch(0.22_0.04_160)] py-20 text-[oklch(0.95_0.01_150)]">
      <div className="mx-auto w-full max-w-6xl px-4">
        <div className="text-center">
          ...
          <SlideUp delay={0.1}>
            <p className="mt-3 text-[oklch(0.78_0.01_150)]">
              Hear from the people who chose to work with Trinity.
            </p>
          </SlideUp>
        </div>
