  ...
  return (
    ...
    >
      ...
      >
        <Link
          to="/"
          className="text-sm font-semibold tracking-[0.25em] text-foreground transition-opacity hover:opacity-80"
        >
          TRINITY
        </Link>
      ...
      {open && (
        <div
          className="mt-2 rounded-2xl bg-surface p-4 md:hidden"
          style={{ boxShadow: "var(--shadow-nav)" }}
        >
          <ul className="space-y-2">
            {links.map((l) => (
              <li key={l.label}>
                <a
                  ...
                  className="block rounded-xl px-3 py-2 text-foreground/80 hover:bg-muted"
                >
                  {l.label}
                </a>
              </li>
            ...
            <li>
              <a
                href="#contact"
                onClick={() => setOpen(false)}
                className="mt-2 block rounded-full bg-primary px-4 py-2 text-center text-primary-foreground"
              >
                Consultation
              </a>
            </li>
