    ...
    <section className="relative mx-auto mt-16 w-full max-w-4xl px-4 text-center">
      ...
      >
        <motion.div variants={itemVariants} className="flex items-center justify-center">
          ...
          <span className="ml-4 text-sm font-medium text-muted-foreground">Trusted by discerning clients</span>
        </motion.div>

        <motion.h1 variants={itemVariants} className="mt-8 text-5xl font-bold leading-[1.05] tracking-tight md:text-6xl lg:text-7xl">
          <span className="text-gradient">Spaces That Inspire,</span>
          <br /> <span className="text-foreground">Designed for You</span>
        </motion.h1>

        <motion.p variants={itemVariants} className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-muted-foreground md:text-lg font-medium">
